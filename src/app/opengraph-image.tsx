      ...
      >
        ...
        >
          ...
          >
            ...
            <div style={{ marginLeft: '16px', color: '#94a3b8', fontSize: 14 }}>nav — -zsh — 80x24</div>
          </div>
          ...
          >
            {/* Command */}
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', fontSize: 28, marginBottom: '10px' }}>
            ...
            {/* Output */}
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', fontSize: 24, color: '#cbd5e1' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                ...
                <div style={{ width: '150px', color: '#64748b' }}>DrivenData</div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginTop: '20px', color: '#22c55e' }}>
                <div>✓</div>
        ...
        {/* Footer Branding */}
        <div style={{ position: 'absolute', bottom: '40px', color: '#475569', fontSize: 24, letterSpacing: '4px', fontWeight: 'bold' }}>
