...
export interface ValidationRule {
  name: string;
  description: string;
  validator: (contest: RawContest, index: number, allContests?: RawContest[]) => Promise<{ errors?: string[], warnings?: string[] }>;
}
 ...
 * 错误类型
 */
export type ErrorType = 'NETWORK' | 'PARSING' | 'AI_PROCESSING' | 'STORAGE' | 'VALIDATION' | 'RATE_LIMIT';
